...
O admin entra em `/admin` para criar eventos, configurar mesas por setor/cor, filtrar reservas, confirmar pagamentos manualmente e cancelar reservas pendentes ou pagas, mantendo historico. O cliente entra em `/reservas` para reservar mesas.
